...
if __name__ == "__main__":
    ...
    while(line<200):
        ...
        for epoch in range(pre_epoch, EPOCH):
            ...
            if (auc_val>=0.65) and (auc_exter2>0.5) and auc_exter1>0.5:
                #if (auc_train - auc_test<0.1):
                    #if epoch>=2:
                        print('Saving model......')
                        torch.save(net.state_dict(), '%s/18-i%01d_E%02d_1l%.04f_1w%.03f_2l%.04f_2w%.03f_t%.03f_v%.03f_e%.03f_e%.03f.pth'
